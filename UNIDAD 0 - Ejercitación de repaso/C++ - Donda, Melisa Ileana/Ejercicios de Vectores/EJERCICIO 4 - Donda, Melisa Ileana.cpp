/* EJERCICIO N°4: Crear un procedimiento que reciba un vector de N números naturales desordenados y retorne
el mismo ordenado de menor a mayor (puede contener elementos repetidos).
*/
